...
async function processTransactionHex(transactionHex, description, imageName) {
    try {
        ...
        const signCommand = `bitcoin-cli -rpcwallet=${walletName} signrawtransactionwithwallet ${transactionHex}`;
        ...
        const sendCommand = `bitcoin-cli -rpcwallet=${walletName} sendrawtransaction ${signedHex}`;
